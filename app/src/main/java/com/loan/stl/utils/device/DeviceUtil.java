package com.loan.stl.utils.device;
...
public class DeviceUtil {
    ...
    public static String getString(int r){
        return LoanApplication.getContext().getResources().getString(r);
    }

    public static LinearLayoutManager getLinear(int r){
        return new LinearLayoutManager(LoanApplication.getContext());
    }
}
