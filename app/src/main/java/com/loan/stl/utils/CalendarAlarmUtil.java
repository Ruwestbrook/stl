...
public class CalendarAlarmUtil {
    ...
    private static String CALENDARS_NAME = "thfq";
    private static String CALENDARS_ACCOUNT_NAME = "51zhz@51zhz.com";
    ...
    private static long addCalendarAccount(Context context) {
       ...
       // value.put(CalendarContract.Calendars.CALENDAR_DISPLAY_NAME, context.getResources().getString(R.string.app_name));
     ...
     * @param context
     */
    public static void deleteAndAddCalendarEvent(final Context context, final String title, final String desc, final String date) {
        // 获取日历账户的id
        ...
        long start = getDateLong(date);
        event.put(CalendarContract.Events.DTSTART, start);
        event.put(CalendarContract.Events.ORGANIZER, CALENDARS_ACCOUNT_NAME);
...
//        CalendarContract.Events.
     ...
     * 删除日历事件
     */
    public static void deleteCalendarEvent(final Context context) {
        ...
        try {
            ...
            if (eventCursor.getCount() > 0) {
                //遍历所有事件，找到ORGANIZER跟需要查询的ORGANIZER一样的项
                for (eventCursor.moveToFirst(); !eventCursor.isAfterLast(); eventCursor.moveToNext()) {
                    String eventTitle = eventCursor.getString(eventCursor.getColumnIndex(CalendarContract.Events.ORGANIZER));
                    Log.e("-----xxxxxxxxxxxx----", eventTitle);
                    if (eventTitle.equals(CALENDARS_ACCOUNT_NAME)) {
